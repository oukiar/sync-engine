...
def _encode(obj, namespace_public_id=None, expand=False, is_n1=False):
    ...
    if isinstance(obj, Namespace):  # These are now "accounts"
        ...
        base = {
            ...
            'recentparticipant': {'name':obj.most_recent_sender_participant[0], 'email':obj.most_recent_sender_participant[1]}, #obj.most_recent_sender_participant(), #obj.recentparticipant,
